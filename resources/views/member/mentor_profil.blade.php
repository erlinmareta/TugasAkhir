                        ...
                        <div class="d-flex flex-column flex-lg-row align-items-center">
                            <div class="d-flex flex-column flex-md-row align-items-center flex mb-16pt mb-lg-0 text-center text-md-left">
                                <div class="mb-16pt mb-md-0 mr-md-24pt">
                                    <img src="../learnly/public/images/illustration/teacher/128/black.svg"
                                         width="104"
                                         alt="teacher">
                                </div>
                                <div class="flex">
                            ...
                            <div class="col-lg-8">
                                ...
                                <div class="row card-group-row mb-8pt">
                                            ...
                                            <div class="card-body d-flex align-items-center">
                                                <a href="course.html"
                                                   class="avatar avatar-4by3 overlay overlay--primary mr-12pt">
                                                    <img src="../learnly/public/images/Lymphoma-bro.png" alt="Angular Routing In-Depth" class="avatar-img rounded">
                                                    <span class="overlay__content"></span>
                                                </a>
                                                <div class="flex">
                                                    <a class="card-title mb-4pt" href="course.html">Sistem Saraf pada manusia</a>
                                    ...
                                    <div class="col-sm-6 card-group-row__col">
                                        <div class="card card-sm card-group-row__card">
                                            <div class="card-body d-flex align-items-center">
                                                <a href="course.html"
                                                   class="avatar avatar-4by3 overlay overlay--primary mr-12pt">
                                                    <img src="../learnly/public/images/Lymphoma-bro.png" alt="Angular Unit Testing" class="avatar-img rounded">
                                                    <span class="overlay__content"></span>
                                                </a>
                                                <div class="flex">
                                                    <a class="card-title mb-4pt" href="course.html">Sistem saraf pada manusia</a>
                                    ...
                                    <div class="col-sm-6 card-group-row__col">
                                        <div class="card card-sm card-group-row__card">
                                            <div class="card-body d-flex align-items-center">
                                                <a href="course.html"
                                                   class="avatar avatar-4by3 overlay overlay--primary mr-12pt">
                                                    <img src="../learnly/public/images/Lymphoma-bro.png" alt="Introduction to TypeScript"class="avatar-img rounded">
                                                    <span class="overlay__content"></span>
                                                </a>
                                                <div class="flex">
                                                    <a class="card-title mb-4pt" href="course.html">Sistem Saraf pada Manusia</a>
                                    ...
                                    <div class="col-sm-6 card-group-row__col">
                                        <div class="card card-sm card-group-row__card">
                                            <div class="card-body d-flex align-items-center">
                                                <a href="course.html" class="avatar avatar-4by3 overlay overlay--primary mr-12pt">
                                                    <img src="../learnly/public/images/Lymphoma-bro.png" alt="Learn Angular Fundamentals" class="avatar-img rounded">
                                                    <span class="overlay__content"></span>
                                                </a>
                                                <div class="flex">
                                                    <a class="card-title mb-4pt" href="course.html">Sistem Saraf pada Manusia</a>
