...
<body class="layout-sticky-subnav layout-learnly ">
                ...
                <div class="row">
                    <div class="col-lg-8">
                        ...
                        @else
                            ...
                            @else
                            <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#staticBackdrop-{{ $materi->id }}">
    ...
    <div class="page-section bg-alt">
        ...
        <div class="modal fade" id="staticBackdrop-{{ $materi->id }}" data-backdrop="static" data-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                    ...
                    <form action="{{ url('/member/rating/'.$materi->id) }}" method="POST">
                        ...
                        <div class="modal-body">
                            <div class="input-group">
                                <div class="input-group-prepend">
                                    <div class="input-group-text">
                                        <input type="radio" name="rating" id="rating" aria-label="Radio button for following text input" value="1">
                                    </div>
                                </div>
                                <div class="ml-2 mt-1">
                            ...
                            <div class="input-group">
                                <div class="input-group-prepend">
                                    <div class="input-group-text">
                                        <input type="radio" name="rating" id="rating" aria-label="Radio button for following text input" value="2">
                                    </div>
                                </div>
                                <div class="ml-2 mt-1">
                                    <i class="fa fa-star"></i>
                            ...
                            <div class="input-group">
                                <div class="input-group-prepend">
                                    <div class="input-group-text">
                                        <input type="radio" name="rating" id="rating" aria-label="Radio button for following text input" value="3">
                                    </div>
                                </div>
                                <div class="ml-2 mt-1">
                                    <i class="fa fa-star"></i>
                            ...
                            <div class="input-group">
                                <div class="input-group-prepend">
                                    <div class="input-group-text">
                                        <input type="radio" name="rating" id="rating" aria-label="Radio button for following text input" value="4">
                                    </div>
                                </div>
                                <div class="ml-2 mt-1">
                                    <i class="fa fa-star"></i>
                            ...
                            <div class="input-group">
                                <div class="input-group-prepend">
                                    <div class="input-group-text">
                                        <input type="radio" name="rating" id="rating" aria-label="Radio button for following text input" value="5">
                                    </div>
                                </div>
                                <div class="ml-2 mt-1">
                                    <i class="fa fa-star"></i>
