                    ...
                    <div class="container page__container">
                        ...
                        <div class="d-flex flex-column flex-lg-row align-items-center">
                            <div class="d-flex flex-column flex-md-row align-items-center flex mb-16pt mb-lg-0 text-center text-md-left">
                                ...
                                <div class="flex">
                                    <h1 class="h2 m-0">Pendahuluan <b>Sistem Saraf pada Manusia</b></h1>
                                    ...
                                    <div class="accordion__item open">
                                        ...
                                        <div class="accordion__menu collapse show"
                                            ...
                                            <div class="accordion__menu-link">
                                                ...
                                                <a class="flex"
                                                   href="student-lesson.html">Pendahuluan</a>
                                            ...
                                            <div class="accordion__menu-link active">
                                                ...
                                                <a class="flex"
                                                   href="student-lesson.html">Pengertian Sistem Saraf</a>
                                            ...
                                            <div class="accordion__menu-link">
                                                ...
                                                <a class="flex"
                                                   href="student-lesson.html">Fungsi Sistem Saraf</a>
                                            ...
                                            <div class="accordion__menu-link">
                                                ...
                                                <a class="flex"
                                                   href="{{ url('member/quis_student') }}">Quiz: Sistem Saraf pada Manusia</a>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="accordion__item">
