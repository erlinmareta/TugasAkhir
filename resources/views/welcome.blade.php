                                    ...
                                    <div class="card card-sm card--elevated p-relative o-hidden overlay overlay--primary-dodger-blue js-overlay card-group-row__card"
                                        ...
                                        <a href="student-course.html" class="card-img-top js-image" data-position=""
                                            ...
                                            <img width="400" height="210"
                                                src="{{ url('/storage/' . $class->gambar) }}" style="width:70px">
                                        ...
                                        <div class="card-body flex">
                                            <div class="d-flex">
                                                <div class="flex">
                                                    <a class="card-title"
                                                        href="student-course.html">{{ $class->judul }}</a>
                                                    <small
                                    ...
                                    <div class="popoverContainer d-none">
                                        ...
                                        <div class="row align-items-center" class="mb-12pt">
                                            ...
                                            <div class="col text-right">
                                                <a href="{{ url('member/class_detail/' . $class->id) . '/' . $class->materi->first()->id }}"
