...
<htmlearnly lang="en"
    ...
    <head>
        ...
        <!-- Preloader -->
        <link type="text/css"
              href="../learnly/public/vendor/spinkit.css"
              rel="stylesheet">

        <!-- Perfect Scrollbar -->
        <link type="text/css"
              href="../learnly/public/vendor/perfect-scrollbar.css"
              rel="stylesheet">

        <!-- Material Design Icons -->
        <link type="text/css"
              href="../learnly/public/css/material-icons.css"
              rel="stylesheet">

        <!-- Font Awesome Icons -->
        <link type="text/css"
              href="../learnly/public/css/fontawesome.css"
              rel="stylesheet">

        <!-- Preloader -->
        <link type="text/css"
              href="../learnly/public/css/preloader.css"
              rel="stylesheet">

        <!-- App CSS -->
        <link type="text/css"
              href="../learnly/public/css/app.css"
              rel="stylesheet">
    ...
    <div class="sk-bounce-dot"></div>
                ...
                <div class="mdk-box mdk-box--bg-white-35 bg-white js-mdk-box mb-0"
                    ...
                    <div class="mdk-box__bg">
                        <div class="mdk-box__bg-front"
                             style="background-image: url(../learnly/public/images/study.jpeg);"></div>
                    </div>
                    <div class="mdk-box__content d-flex align-items-center justify-content-center container page__container text-center py-112pt"
                        ...
                        <div class="card card--transparent mb-0">
                            <div class="card-body px-32pt py-24pt">
                                ...
                                <p class="lead measure-lead mx-auto mb-32pt">Semua solusi dari masalah belajar anda ada disini </p>
                                <a href="/login"
                                   class="btn btn-lg btn-accent btn--raised mb-16pt">yuk mulai </a>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="page-section border-bottom-2">
                    <div class="container page__container">
                        <div class="page-separator">
                            <div class="page-separator__text">Materi Belajar</div>
                        </div>
                                    ...
                                    <div class="card-body flex">
                                        <div class="d-flex">
                                            <div class="flex">
                                                ...
                                                <small class="text-50 font-weight-bold mb-4pt">Erlin Maresta</small> <br>
                                            </div>
                                ...
                                <div class="popoverContainer d-none">
                                    <div class="media">
                                        <div class="media-left mr-12pt">
                                            <img src="../learnly/public/images/paths/sketch_40x40@2x.png"
                                                 width="40"
                                                 height="40"
                                                 alt="Angular"
                                                 class="rounded">
                            ...
                            <div class="col-md-6 col-lg-4 col-xl-3 card-group-row__col">
                                ...
                                <div class="card card-sm card--elevated p-relative o-hidden overlay overlay--primary-dodger-blue js-overlay card-group-row__card"
                                    ...
                                    <div class="card-footer">
                                        <div class="row justify-content-between">
                                            <div class="col-auto d-flex align-items-center">
                                                <span class="material-icons icon-16pt text-50 mr-4pt">account_circle</span>
                                                <p class="flex text-50 lh-1 mb-0"><small>7 peserta</small></p>
                                                
                                            </div>
                                            <div class="col-auto d-flex align-items-center">
                                                <span class="material-icons icon-16pt text-50 mr-4pt">play_circle_outline</span>
                                                <p class="flex text-50 lh-1 mb-0"><small>1 materi</small></p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="popoverContainer d-none">
                                    <div class="media">
                                        <div class="media-left mr-12pt">
                                            <img src="../learnly/public/images/paths/flinto_40x40@2x.png"
                                                 width="40"
                                                 height="40"
                                                 alt="Angular"
                                                 class="rounded">
                            ...
                            <div class="col-md-6 col-lg-4 col-xl-3 card-group-row__col">
                                ...
                                <div class="popoverContainer d-none">
                                    <div class="media">
                                        <div class="media-left mr-12pt">
                                            <img src="../learnly/public/images/paths/photoshop_40x40@2x.png"
                                                 width="40"
                                                 height="40"
                                                 alt="Angular"
                                                 class="rounded">
                            ...
                            <div class="col-md-6 col-lg-4 col-xl-3 card-group-row__col">
                                ...
                                <div class="popoverContainer d-none">
                                    <div class="media">
                                        <div class="media-left mr-12pt">
                                            <img src="../laernly/public/images/paths/figma_40x40@2x.png"
                                                 width="40"
                                                 height="40"
                                                 alt="Angular"
                                                 class="rounded">
                            ...
                            <div class="row">
                                <div class="col-sm-6 col-md-4">
                                    ...
                                    <blockquote class="blockquote mb-0">
                                        <p class="text-70 small mb-0">materi mudah dipahami, konten sangat menarik</p>
                                    </blockquote>
                                </div>
                                <div class="media ml-12pt">
                                    ...
                                    <div class="media-body media-middle">
                                        <a href="student-profile.html"
                                           class="card-title">Erlin Maresta</a>
                    ...
                    <a href="index.html"
                       class="sidebar-brand ">
                        ...
                        <span class="avatar avatar-xl sidebar-brand-icon h-auto">
                            ...
                            <span class="avatar-title rounded bg-primary"><img src="../learnly/public/images/illustration/student/128/white.svg"
                                     class="img-fluid"
                                     alt="logo" /></span>
        ...
        <!-- jQuery -->
        <script src="../learnly/public/vendor/jquery.min.js"></script>

        <!-- Bootstrap -->
        <script src="../learnly/public/vendor/popper.min.js"></script>
        <script src="../learnly/public/vendor/bootstrap.min.js"></script>

        <!-- Perfect Scrollbar -->
        <script src="../learnly/public/vendor/perfect-scrollbar.min.js"></script>

        <!-- DOM Factory -->
        <script src="../learnly/public/vendor/dom-factory.js"></script>

        <!-- MDK -->
        <script src="../learnly/public/vendor/material-design-kit.js"></script>

        <!-- App JS -->
        <script src="../learnly/public/js/app.js"></script>

        <!-- Preloader -->
        <script src="../learnly/public/js/preloader.js"></script>
