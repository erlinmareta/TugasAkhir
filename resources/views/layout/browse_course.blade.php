        ...
        <div class="page-separator">
            ...
            <div class="row card-group-row">
                ...
                <div class="popoverContainer d-none">
                    ...
                    <p class="my-16pt text-70">Kelas ini berisi tentang materi Sistem Saraf pada manusia,dari segala kalangan bisa mengikuti kelas ini,
                        materi belajar yang menarik yang disajikan menggunakan video. kelas ini dibagi ke beberapa bab, diantaranya :
                    </p>
                    ...
                    <div class="mb-16pt">
                        ...
                        <div class="d-flex align-items-center">
                            <span class="material-icons icon-16pt text-50 mr-8pt">check</span>
                            <p class="flex text-50 lh-1 mb-0"><small>fungsi sistem saraf pada tubuh manusia</small></p>
                        </div>
                    </div>
                    ...
                    <div class="row align-items-center">
                        <div class="col-auto">
                                ...
                                <div class="col text-right">
                                 <a href="{{ url('member/class_detail') }}" class="btn btn-primary">Mulai Belajar</a>
                            </div>
                        </div>
                  </div>
              </div>
                ...
                <div class="popoverContainer d-none">
                    ...
                    <div class="row align-items-center">
                        <div class="col-auto">
                                ...
                                <div class="col text-right">
                                 <a href="member/browse_course" class="btn btn-primary">Mulai Belajar</a>
                            </div>
                        </div>
                  </div>
              </div>
                ...
                <div class="popoverContainer d-none">
                    ...
                    <div class="row align-items-center">
                        <div class="col-auto">
                                ...
                                <div class="col text-right">
                                 <a href="student-course.html" class="btn btn-primary">Mulai Belajar</a>
                            </div>
                        </div>
                  </div>
              </div>
