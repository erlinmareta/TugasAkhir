                                        ...
                                        @if ($kelas->count() > 0)
                                            @foreach ($kelas as $item)
                                                <tr>
                                                    ...
                                                    <td>{{ $item->judul }}</td>
                                                    <td><img src="{{ url('/storage/' . $item->gambar) }}"
                                                            style="width:70px"></td>
                                                    ...
                                                    <td>
                                                        <a class="btn btn-sm btn-success-outline"
                                                            href="{{ url('admin/kelas/info/' . $item->id) }}"
                                                            title="info"><span class="fa fa-info"></span> Info |</a>
                                                        <a class="btn btn-sm btn-success-outline"
                                                            href="{{ route('admin.kelasDetail', $item->id) }}"
                                                            title="detail"><span class="fa fa-edit"></span> Detail |</a>
                                                    </td>
                                                </tr>
                                            @endforeach
                                        @else
